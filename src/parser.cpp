...
void PARSER::ReadAuxFile()
{
    ...
    if(!fin)
    {
        cerr << left << setw(10) << benchmark << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    string temp;
    ...
    fin.close();
    cout << left << setw(10) << ".aux" << " complete" << endl;
}
void PARSER::ReadNodeFile()
{
    ...
    if(!fin)
    {
        cerr << left << setw(10) << ".node" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    string line;
    getline(fin, line);
    ...
    fin.close();
    cout << left << setw(10) << ".node" << " complete" << endl;
}
void PARSER::ReadNetFile()
{
    ...
    if(!fin)
    {
        cerr << left << setw(10) << ".net" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    string line;
    getline(fin, line);
    ...
    fin.close();
    cout << left << setw(10) << ".net" << " complete" << endl;
}
...
void PARSER::ReadPlFile()
{
    ...
    if(!fin)
    {
        cerr << left << setw(10) << ".pl" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    string line;
    getline(fin, line);
    ...
    fin.close();
    cout << left << setw(10) << ".pl" << " complete" << endl;
}
void PARSER::ReadGpplFile()
{
    ...
    if(!fin)
    {
        cerr << left << setw(10) << ".gp.pl" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    string line;
    getline(fin, line);
    ...
    chip_area = chip_W_H.GetProduct();
    fin.close();
    cout << left << setw(10) << ".gp.pl" << " complete" << endl;
}
void PARSER::ReadSclFile()
{
    ...
    if(!fin)
    {
        cerr << left << setw(10) << ".scl" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    string line;
    getline(fin, line);
    ...
    while(getline(fin, line))
    {
        ...
        else if(line.substr(0, 8) == "  Height")
        {
            // row
        ...
        else if(line.substr(0, 13) == "  Sitespacing")
        {
            // row
            ROWS.back()->Sitespacing = GetNum(line);
        }
        else if(line.substr(0, 8) == "  Subrow")
        {
            // row
            ROWS.back()->lb.x = GetNum(line);
            ROWS.back()->NumSites = GetNum(line.substr(25));
    ...
    fin.close();
    cout << left << setw(10) << ".scl" << " complete" << endl;
}
// write
void PARSER::WriteChipFile()
{
    ...
    if(!fout)
    {
        cerr << left << setw(10) << "_chip.dat" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    fout << "\n# core region\n";
    ...
    fout << chip_lb.x << ", " << chip_lb.y << "\n\n";
    fout.close();
    cout << left << setw(10) << "_chip.dat" << " complete" << endl;
}
void PARSER::WriteCellFile()
{
    ...
    if(!fout)
    {
        cerr << left << setw(10) << "_cell.dat" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    fout << "\n# FENCE DEFAULT\n";
    fout << "0, 0\n\n";
    ...
    fout.close();
    cout << left << setw(10) << "_cell.dat" << " complete" << endl;
}
void PARSER::WritePadFile()
{
    ...
    if(!fout)
    {
        cerr << left << setw(10) << "_pad.dat" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    fout << "\n# PADS\n";
    fout << "0, 0\n\n";
    ...
    fout.close();
    cout << left << setw(10) << "_pad.dat" << " complete" << endl;
}
void PARSER::WritePadPinFile()
{
    ...
    if(!fout)
    {
        cerr << left << setw(10) << "_pad_pin.dat" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    fout << "\n# PAD_PIN\n";\
    fout << "0, 0\n\n";
    ...
    fout.close();
    cout << left << setw(10) << "_pad_pin.dat" << " complete" << endl;
}
void PARSER::WritePltFile()
{
    ...
    if(!fout)
    {
        cerr << left << setw(10) << ".plt" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    CalTotal();
    fout << "set nokey\n";
    ...
    fout.close();
    cout << left << setw(10) << ".plt" << " complete" << endl;
}
// hw2
void PARSER::WritePloutFile()
{
    fout.open(benchmark_dir + benchname + ".pl_out");
    if(!fout)
    {
        cerr << left << setw(10) << ".pl_out" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    for(auto const &pad : PADS)
    {
    ...
    fout.close();
    cout << left << setw(10) << ".pl_out" << " complete" << endl;
}
// hw3
void PARSER::WriteLegalPlFile()
{
    ...
    if(!fout)
    {
        cerr << left << setw(10) << ".legal.pl" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    ...
    fout.close();
    cout << left << setw(10) << ".legal.pl" << " complete" << endl;
}
void PARSER::WriteRowFile(ABACUS &ABACUS_obj)
{
    ...
    if(!fout)
    {
        cerr << left << setw(10) << "row.dat" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    fout << "\n# ROWS\n";\
    fout << "0, 0\n\n";
    ...
    fout.close();
    cout << left << setw(10) << "_row.dat" << " complete" << endl;
}
// matlab
void PARSER::WriteMFile(CS &CS_obj)
{
    fout.open("plt/" + benchname + "/" + benchname + ".m");
    if(!fout)
    {
        cerr << left << setw(10) << ".m" << " failed" << endl;
        exit(EXIT_FAILURE);
    }
    fout << "axis equal;\n" << "hold on\n" << "grid on\n";
    for(auto const &tile : CS_obj.TILES)
    {
        fout << "block_x=[";
        fout << " " << tile->lb.x;
        fout << " " << tile->lb.x;
    ...
    fout.close();
    cout << left << setw(10) << ".m" << " complete" << endl;
}
...
void PARSER::CreatPin(string line)
{
    ...
    if(pad_it != pad_map.end())
    {
        ...
        // net
        NETS.back()->pins.push_back(new_ptr);
        NETS.back()->pads.push_back(pad_ptr);
        return;
    }
}
// pl
